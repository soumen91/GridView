...
public class MyAdapter extends ArrayAdapter<UserBean> {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			mHolder.mName = (TextView) v.findViewById(R.id.txtView);
			mHolder.mBttn = (TextView) v.findViewById(R.id.bttnLike);
		...
		if (mRoomLightBean != null) {
			...
			mHolder.mBttn.setText(mRoomLightBean.getBttn());
